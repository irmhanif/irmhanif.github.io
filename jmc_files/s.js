(function (w, d) {
  ...
  zaraz.i = function (e) {
    ...
    for (var t = 0; t < r.length; t++) {
      ...
      for (var i of (r[t].innerHTML && (a.innerHTML = r[t].innerHTML),
      r[t].attributes))
  ...
  (zaraz.pageVariables = {}),
    ...
    (zaraz.set = function (a, e, t) {
      "object" == typeof e && (e = JSON.stringify(e)),
        ...
        t && "session" == t.scope
          ? sessionStorage.setItem(prefixedKey, e)
          : t && "page" == t.scope
          ? (zaraz.pageVariables[a] = e)
          : localStorage.setItem(prefixedKey, e),
        (zaraz.__watchVar = { key: a, value: e });
    });
  for (const { m: a, a: e } of zarazData?.q && zarazData?.q?.filter(({ m: a }) =>
    ["debug", "set"].includes(a)
  ))
    zaraz[a](...e);
  for (const { m: a, a: e } of zaraz.q) zaraz[a](...e);
    ...
    (zaraz._processDataLayer = (a) => {
      if (a.event) {
        if (
          ...
          zarazData.dataLayerIgnore.includes(a.event)
        )
          return;
        let e = {};
