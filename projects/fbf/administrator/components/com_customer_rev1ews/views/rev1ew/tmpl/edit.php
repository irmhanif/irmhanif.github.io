...
$document->addStyleSheet(JUri::root() . 'media/com_customer_rev1ews/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_customer_rev1ews&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="rev1ew-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CUSTOMER_REV1EWS_TITLE_REV1EW', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				?>
				<?php
			//	    echo $this->form->renderField('reviewvalue');
				...
				<?php endif; ?>				<?php echo $this->form->renderField('tittle'); ?>
