 ...
 * @since  1.6
 */
class PartnersViewPartner extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PARTNERS_TITLE_PARTNER'), 'partner.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_partners.partner', $this->item->id);
		}
