 ...
 * @since  1.6
 */
class PartnersViewPartners extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		PartnersHelper::addSubmenu('partners');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_PARTNERS_TITLE_PARTNERS'), 'partners.png');
		...
		{
			JToolBarHelper::preferences('com_partners');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_partners&view=partners');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_PARTNERS_PARTNERS_TITLE'),
			'a.`logo`' => JText::_('COM_PARTNERS_PARTNERS_LOGO'),
		);
	}
