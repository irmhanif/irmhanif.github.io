 ...
 class pData
  {
   ...
   function AddSerie($SerieName="Serie1")
    {
	 $this->DataDescription["Values"] = empty($this->DataDescription["Values"]) ? array() : $this->DataDescription["Values"];
   ...
   function SetAbsciseLabelSerie($SerieName = "Name")
    {
	 $this->DataDescription["Position"] = empty($this->DataDescription["Position"]) ? array() : $this->DataDescription["Position"];
     $this->DataDescription["Position"] = $SerieName;
    }

   function SetSerieName($Name,$SerieName="Serie1")
    {
	 $this->DataDescription["Description"] = empty($this->DataDescription["Description"]) ? array() : $this->DataDescription["Description"];
     $this->DataDescription["Description"][$SerieName] = $Name;
    }

   function SetXAxisName($Name="X Axis")
    {
	 $this->DataDescription["Axis"] = empty($this->DataDescription["Axis"]) ? array() : $this->DataDescription["Axis"];
   ...
   function SetXAxisFormat($Format="number")
    {
     $this->DataDescription["Format"] = empty($this->DataDescription["Format"]) ? array() : $this->DataDescription["Format"];
   ...
   function SetXAxisUnit($Unit="")
    {
	    $this->DataDescription["Unit"] = empty($this->DataDescription["Unit"]) ? array() : $this->DataDescription["Unit"];
   ...
   function SetSerieSymbol($Name,$Symbol)
    {
	    $this->DataDescription["Symbol"] = empty($this->DataDescription["Symbol"]) ? array() : $this->DataDescription["Symbol"];
