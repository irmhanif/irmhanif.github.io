 ...
 * @since  1.6
 */
class Customized_tripViewPlace extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CUSTOMIZED_TRIP_TITLE_PLACE'), 'place.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_customized_trip.place', $this->item->id);
		}
