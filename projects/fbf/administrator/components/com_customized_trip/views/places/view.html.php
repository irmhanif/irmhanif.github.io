 ...
 * @since  1.6
 */
class Customized_tripViewPlaces extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Customized_tripHelper::addSubmenu('places');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CUSTOMIZED_TRIP_TITLE_PLACES'), 'places.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_customized_trip&view=places');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`placeofdeparture`' => JText::_('COM_CUSTOMIZED_TRIP_PLACES_PLACEOFDEPARTURE'),
		);
	}
