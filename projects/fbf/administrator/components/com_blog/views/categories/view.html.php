 ...
 * @since  1.6
 */
class BlogViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		BlogHelper::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BLOG_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_blog&view=categories');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`category`' => JText::_('COM_BLOG_CATEGORIES_CATEGORY'),
		);
	}
