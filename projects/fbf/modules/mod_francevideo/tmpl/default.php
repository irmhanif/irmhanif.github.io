<?php
/**
 * @copyright	Copyright (c) 2018 fracebyfrench. All rights reserved.
...
.container-fluid {
	...
	margin-left: auto;
      ...
      <video width="100%"  autoplay>
				 <source src="images/bannervideo7.mp4" type="video/mp4" />
				 <source src="images/bannervideo7.ogg" type="video/ogg" />
				 <source src="images/bannervideo7.webm" type="video/webm" />
				 
				 </video></div>
			</video>
		</div>
		<div id="mute" class="res"></div>
  ...
  jQuery(document).ready(function() {
    ...
    /*After end vedio change image*/
     ...
     jQuery(document).ready(function() {
      ...
      jQuery("#mute").css("background-image","url(images/mute1.png");
    }
  ...
  jQuery("#mute").click( function (){
    if( jQuery("video").prop('muted') ) {
     ...
     jQuery("video").prop('muted', true);
      jQuery("#mute").css("background-image","url(images/mute.png");
    }
  });
  });
	</script>
