...
<div class="inner_page_layout">
    ...
    <div class="about_trip">
        ...
        You build your travel based on the region you would like <span class="blue">to explore or based on your interest.</span> After you submit your request, we will get back to you within 24 hours with the exact quotation for your perfect trip. </p>
	    ...
	    <div class="price_customize">
	        <div class="submit_reg">
	            <form  Method="POST" id="trip_validate">
					...
					<div class="end_trip">
	                    <p>
	                        <input type="button" value="Book" name="trip_submit" id="trip_submit">
	                    </p>
	                </div>
	            </form>
	        </div>
