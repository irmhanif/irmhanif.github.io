...
<div class="day-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-day"
			  action="<?php echo JRoute::_('index.php?option=com_semicustomized&task=day.save'); ?>"
	...
	<?php echo $this->form->renderField('desciptiion'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_semicustomized&task=dayform.cancel'); ?>"
