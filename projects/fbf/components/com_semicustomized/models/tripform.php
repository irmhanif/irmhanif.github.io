 ...
 * @since  1.6
 */
class SemicustomizedModelTripForm extends JModelForm
{
    private $item = null;
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_semicustomized.trip', 'tripform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $data = Factory::getApplication()->getUserState('com_semicustomized.edit.trip.data', array());
