...
class Fixed_tripModelCreate_trips extends JModelList
{
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			$item->type = JText::_('COM_FIXED_TRIP_CREATE_TRIPS_TYPE_OPTION_' . strtoupper($item->type));

			$item->planning1 = JText::_('COM_FIXED_TRIP_CREATE_TRIPS_PLANNING1_OPTION_' . strtoupper($item->planning1));
		}
