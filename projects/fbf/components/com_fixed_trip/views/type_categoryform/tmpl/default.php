...
<div class="type_category-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-type_category"
			  action="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=type_category.save'); ?>"
	...
	<?php echo $this->form->renderField('description'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=type_categoryform.cancel'); ?>"
