...
<div class="create_day-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-create_day"
			  action="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=create_day.save'); ?>"
	...
	<?php echo $this->form->renderField('description'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=create_dayform.cancel'); ?>"
