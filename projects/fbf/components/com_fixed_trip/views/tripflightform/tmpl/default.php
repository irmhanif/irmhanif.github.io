...
<div class="tripflight-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-tripflight"
			  action="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=tripflight.save'); ?>"
	...
	<?php echo $this->form->renderField('title'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=tripflightform.cancel'); ?>"
