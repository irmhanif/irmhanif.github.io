...
<div class="place_of_departure-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-place_of_departure"
			  action="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=place_of_departure.save'); ?>"
	...
	<?php echo $this->form->renderField('title'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=place_of_departureform.cancel'); ?>"
			...
			<input type="hidden" name="task"
				   value="place_of_departureform.save"/>
