...
<div class="datecategory-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-datecategory"
			  action="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=datecategory.save'); ?>"
	...
	<?php echo $this->form->renderField('end_date'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_fixed_trip&task=datecategoryform.cancel'); ?>"
