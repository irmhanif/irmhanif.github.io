...
<div class="innerpage_banner">    
	 ...
	 <?php
	$db = JFactory::getDbo();
	$new_blog="SELECT * FROM  `#__blog_france`  ORDER BY id DESC LIMIT 3";   
...
<div class="last_content">
	<?php
	$db = JFactory::getDbo();
	$new_blog4="SELECT * FROM  `#__blog_france` LIMIT 1";   
...
<div class="menu_blog1">
		...
		foreach($blogcate_res as $blogcate_resdisp) {
		    ...
		    echo '<div class="add_post"><p class="add_bg"><span class="desc"><a href="index.php?option=com_blog&view=france&cid='.$blogcateid.'">'.$blogcategory.'</a></span></p></div>';
		}
...
<div class="latest_post">
	...
	<?php
	$db = JFactory::getDbo();
	$new_blog1="SELECT * FROM  `#__blog_france`  ORDER BY id DESC  ";   
	...
	?>
<div class="add_post">	
<a href="index.php?option=com_blog&view=france&layout=bview&id=<?php echo $id;?>">
