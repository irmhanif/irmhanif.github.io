 ...
 * @since  1.6
 */
class Common_price_managementControllerPricemanagementForm extends JControllerForm
{
	/**
	...
	public function edit($key = NULL, $urlVar = NULL)
	{
		...
		// Get the model.
		$model = $this->getModel('PricemanagementForm', 'Common_price_managementModel');
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($data === false)
		{
			...
			$app->setUserState('com_common_price_management.edit.pricemanagement.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_common_price_management.edit.pricemanagement.id');
			$this->setRedirect(JRoute::_('index.php?option=com_common_price_management&view=pricemanagementform&layout=edit&id=' . $id, false));
		...
		{
			// Save the data in the session.
			$app->setUserState('com_common_price_management.edit.pricemanagement.data', $data);
		...
		$item = $menu->getActive();
		$url  = (empty($item->link) ? 'index.php?option=com_common_price_management&view=pricemanagements' : $item->link);
	...
	public function cancel($key = NULL)
	{
		...
		$editId = (int) $app->getUserState('com_common_price_management.edit.pricemanagement.id');
