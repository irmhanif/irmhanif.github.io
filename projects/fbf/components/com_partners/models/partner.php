 ...
 * @since  1.6
 */
class PartnersModelPartner extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		else
		{
			...
			Factory::getApplication()->setUserState('com_partners.edit.partner.id', $id);
		}
            ...
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new Exception(JText::_('COM_PARTNERS_ITEM_NOT_LOADED'), 403);
                        }
                    }
